...
export function AuthReminderDialog() {
  ...
  const renderUpsellContent = () => (
    <div className="flex flex-col sm:flex-row w-full">
      ...
      <div className="flex flex-col bg-white px-4 pt-14 pb-5 sm:px-6 sm:py-7 w-full sm:w-1/2 flex-shrink-0 relative">
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className={`w-full ${dialogMaxWidth} sm:max-h-[92vh] max-h-[85vh] overflow-y-auto border-0 p-0 ${dialogThemeClasses} sm:top-[50%] top-[52%] translate-y-[-50%]`}>
