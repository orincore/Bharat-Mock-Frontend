...
export default function BlogsClient({ initialData }: { initialData: InitialData }) {
  const [articles, setArticles] = useState<Blog[]>(initialData.articles);
  ...
  const [pagination, setPagination] = useState({ page: 1, limit: 12, total: initialData.total, totalPages: initialData.totalPages });
